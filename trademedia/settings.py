"""
Django settings for trademedia project.
...
SECRET_KEY = 'gn_h&w*cr74m((jq(d6&*kg5lafjx%2-@i9yeahd)$qyom4q1n'
...
LOGIN_URL = '/login'
LOGIN_REDIRECT_URL = '/media/profile'
...
WSGI_APPLICATION = 'trademedia.wsgi.application'
